...
#     --env-file /home/martin/ZNoBackup/repos/homeremote-building/settings/.env \
#     -v /home/martin/ZNoBackup/repos/homeremote-building/settings/auth.json:/app/dist/auth.json \
#     -p 3201:3200 \
